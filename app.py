...
uploaded_file = st.file_uploader("Choose Whatapp exported text file in 24-hour format for detailed analysis")
...
st.sidebar.link_button("Github", "https://github.com/Sayantan-Sen-2003")
st.sidebar.link_button("linkedin", "https://www.linkedin.com/in/sayantansen05/")